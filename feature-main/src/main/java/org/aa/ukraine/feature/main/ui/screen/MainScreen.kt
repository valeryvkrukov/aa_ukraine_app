            ...
            AppTopBar(
                ...
                actions = {
                    IconButton(onClick = { /* Open city filter */ }) {
                        Icon(Icons.Default.FilterList, contentDescription = stringResource(R.string.app_top_bar_filter))
                    }
                    IconButton(onClick = { /* Search for a group */ }) {
                        Icon(Icons.Default.Search, contentDescription = stringResource(R.string.app_top_bar_search))
                    }
                },
            )
        },
            ...
            AppBottomBar {
                ...
                IconButton(onClick = { onScheduleClick() }) {
                    Icon(
                        ...
                        stringResource(R.string.app_bottom_bar_groups)
                    )
                }
                IconButton(onClick = { /* To the diary */ }) { Icon(Icons.Default.Book, stringResource(R.string.app_bottom_bar_diary)) }
            }
        }
    ) { paddingValues ->
